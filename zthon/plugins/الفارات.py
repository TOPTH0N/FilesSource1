...
#
# This file is a part of < https://github.com/SyntralArabic/SyntralArl/ >
...
ZelzalVP_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗲𝗽𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/Syntral) 𓆪\n\n"
    ...
    "\n𓆩 [𝗥𝗲𝗽𝘁𝗵𝗼𝗻 𝙑𝙖𝙧𝙨 - قنـاة الفـارات](t.me/Syntral_vars) 𓆪"
)
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("**✾╎الفـار {} موجـود ☑️**\n**✾╎قيمـة الفـار : ↶**\n `{}` \n\n**✾╎قنـاة السـورس : @Syntral**".format(input_str, variable))
