# 𝙎𝙔𝙉𝙏𝙍𝘼𝙇
# Copyright (C) 2022 SyntrelArabic. All Rights Reserved
#
# This file is a part of < https://github.com/TOPTH0N/FilesSource1/ >
# PLease read the GNU Affero General Public License in
# <https://github.com/TOPTH0N/FilesSource1/blob/master/LINCENSE/>.
#الملـف حقـوق وكتابـة السيد ⤶ @S_i_D خاص بسـورس ⤶ 𝙎𝙔𝙉𝙏𝙍𝘼𝙇
...
async def zfetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝙎𝙔𝙉𝙏𝙍𝘼𝙇 𓆪 </b> - @Syntrel"
...
async def fetch_info(replied_user, event):
    ...
    if x == 4:
       ...
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝙎𝙔𝙉𝙏𝙍𝘼𝙇 𓆪 </b> - @Syrtrel "
    ...
    if x == 6:
       ...
       caption += f"\n\n<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 Syntrel 𓆪 </b> - @Syntrel "
