...
async def zelzal_gif(event):
    ...
    chat = "@FullSavebot" #Code by T.me/zqqqzq
    ...
    async with borg.conversation(chat) as conv: #Code by T.me/zqqqzq
        try:
            ...
            await conv.send_message(link) #Code by T.me/zqqqzq
            await conv.get_response()
            await asyncio.sleep(2)
...
async def zelzal_lik(event):
    ...
    chat = "@savetok_bot" #Code by T.me/zqqqzq
...
async def zelzal_pin(event):
    ...
    chat = "@GoPinterestBot" #Code by T.me/zqqqzq
